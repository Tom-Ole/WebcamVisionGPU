# Implementation of Computer Vision / Image Processing Effects
...
A CPU implementation of the first Algorithms are found in my other repository: [WebcamVision](https://github.com/Tom-Ole/WebcamVision)
